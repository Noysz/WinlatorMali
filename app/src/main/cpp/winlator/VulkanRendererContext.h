...
struct DummyScanoutContext {
    std::atomic<bool> scanoutActive{false};
    std::atomic<bool> gameFrameDelivered{false};
    void initFromWindow(ANativeWindow*) {}
    void initFromWindows(ANativeWindow*, ANativeWindow*) {}
    void destroy() {}
    void applyPendingCursor() {}
    void setBuffer(AHardwareBuffer*, int, int, int, int, int = -1) {}
    void setDst(int, int, int, int) {}
    bool setCursorImage(void*, short, short, short) { return false; }
    bool setCursorPos(short, short, short, short) { return false; }
    void setFallbackWindow(ANativeWindow*) {}
    void setContainerSize(int, int) {}
    void setSurfaceSize(int, int) {}
    void setVerboseLog(bool) {}
    void* debugGameSC() { return nullptr; }
};
...
public:
    ...
    void initScanoutFromWindows(ANativeWindow*, ANativeWindow*) {}
    void scanoutSetDst(int, int, int, int) {}
    void scanoutSetBuffer(AHardwareBuffer*, int, int, int, int, int = -1) {}
    void scanoutSetCursorImage(void*, short, short, short) {}
    void scanoutSetCursorPos(short, short, short, short) {}
...
private:
    ...
    float             colorSaturation   = 1.0f;    // [0,2]  (slider/100 + 1)
